  ...
  return (
    <div
      style={{
        ...
        height: '100%',
        overflow: 'hidden',
        background: 'linear-gradient(150deg,#EBF3FF 0%,#f8fafc 100%)',
        padding: '8px',
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '4px', marginBottom: '6px' }}>
        {KPI.map((color, i) => (
          ...
          >
            ...
            />
            <div
              style={{ height: '5px', width: '70%', background: color + '50', borderRadius: '2px' }}
            />
          </div>
        ))}
      </div>
      ...
      {/* 2×2 charts */}
      <div
        style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px', marginBottom: '6px' }}
      >
              ...
              {bars.map((h, bi) => (
                <div
                  ...
                  style={{
                    flex: 1,
                    height: `${h}%`,
                    background: bi % 2 === 0 ? color : color + '70',
          ...
          >
            ...
            <div
              style={{
                height: '3px',
                width: '16px',
                background: bg ? (bg.includes('FEF') ? '#FCA5A5' : '#FCD34D') : '#E5E7EB',
                borderRadius: '2px',
              }}
            />
          </div>
