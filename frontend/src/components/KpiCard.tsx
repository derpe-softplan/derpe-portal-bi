...
export function KpiCard({ title, value, subtitle, icon, accent = 'blue', loading, onClick, tooltip }: Props) {
  ...
  return (
    <div
      onClick={onClick}
      style={{ backgroundColor: a.bg, borderColor: 'transparent', borderLeftColor: a.bar, borderLeftWidth: '4px' }}
